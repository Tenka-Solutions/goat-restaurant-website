...
import { getPublicMenu } from "@/sanity/menu-source";
...
export default async function LocalizedMenu({ params }: { params: Promise<{ locale: string }> }) { const { locale } = await params; if (!isLocale(locale)) notFound(); return <MenuPage locale={locale} menuCategories={await getPublicMenu()} />; }
